...
function getmonthlyexpenses(e) {
    return __awaiter(this, void 0, void 0, function* () {
        const expenseTable = document.getElementById('expenseTable');
        const response = yield axios_1.default.get('http://localhost:3000/getmonthlyexpenses', { headers: { "authorization": token } });
...
function weeklyexpenses(e) {
    return __awaiter(this, void 0, void 0, function* () {
        const expenseTable = document.getElementById('expenseTable');
        const response = yield axios_1.default.get('http://localhost:3000/weeklyexpenses', { headers: { "authorization": token } });
        console.log("expenses", response.data.expenses.length);
        expenseTable.innerHTML = `
    <tr><th>Date</th><th>Description</th><th>Category</th><th>Expense</th></tr>`;
        for (let i = 0; i < response.data.expenses.length; i++) {
...
function dailyexpenses(e) {
    return __awaiter(this, void 0, void 0, function* () {
        const expenseTable = document.getElementById('expenseTable');
        const response = yield axios_1.default.get('http://localhost:3000/dailyexpenses', { headers: { "authorization": token } });
        console.log("expenses", response.data.expenses.length);
        expenseTable.innerHTML = `
    <tr><th>Date</th><th>Description</th><th>Category</th><th>Expense</th></tr>`;
        for (let i = 0; i < response.data.expenses.length; i++) {
...
function download() {
    axios_1.default.get('http://localhost:3000/download', { headers: { "authorization": token } })
        .then((response) => {
...
function paginationButtons(ITEMS_PER_PAGE) {
    ...
    axios_1.default.get(`http://localhost:3000/getexpense/${ITEMS_PER_PAGE}`, { headers: { "authorization": token } })
        .then(expenses => {
...
function expensePagination(title, ITEMS_PER_PAGE) {
    axios_1.default.get(`http://localhost:3000/getexpense/${ITEMS_PER_PAGE}/?page=${title}`, { headers: { "authorization": token } })
        .then(expenses => {
        const expenseTable = document.getElementById('expenseTable');
        expenseTable.innerHTML = `
             <tr><th>Date</th><th>Description</th><th>Category</th><th>Expense</th></tr>
...
function paginationuserButtons(ITEMS_PER_PAGE, userId) {
    ...
    axios_1.default.get(`http://localhost:3000/getuserexpense/${userId}/${ITEMS_PER_PAGE}`)
        .then(expenses => {
        console.log("pagination", expenses);
        const parentNodeCart = document.getElementById('expensePagination');
        parentNodeCart.innerHTML = "";
...
function userExpensePagination(title, ITEMS_PER_PAGE, userId) {
    axios_1.default.get(`http://localhost:3000/getuserexpense/${userId}/${ITEMS_PER_PAGE}/?page=${title}`)
        .then(expenses => {
        const expenseTable = document.getElementById('expenseTable');
        expenseTable.innerHTML = `
             <tr><th>Date</th><th>Description</th><th>Category</th><th>Expense</th></tr>
